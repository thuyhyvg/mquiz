...
@section('content')
	<div class="col-md-12">
		<div class="col-md-6">
			...
			action="{{ Route('backend.edit-mon-hoc', [$monhoc->id, 'page'=>Request::get('page', 1)]) }}">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
				<div class="form-group">
					<div class="col-sm-8">
						<input type="text" value="{{old('ten_mon_hoc')?old('ten_mon_hoc'):$monhoc->ten_mon_hoc}}" 
							class="form-control" name="ten_mon_hoc" placeholder="Tên môn học"/>
					</div>
					<div class="col-sm-4">
						<input type="submit" class="btn btn-warning" value="Chỉnh sửa" name="ok"/>
					</div>
				</div>
			</form>
		</div>
